...
write.table(matrix(RES,ncol=3), file="RES_nocovariate_beta05_250obs_5p_mesh1.txt", append=T,row.names=F, col.names=F)
...
write.table(matrix(RES2,ncol=3), file="RES_covariate_beta05_250obs_5p_mesh1.txt", append=T,row.names=F, col.names=F)


} # end for while
#To see results
#n=100
RES_nocovariate_beta05_100obs_5p<-read.table(file="RES_nocovariate_beta05_100obs_5p.txt")
RES_nocovariate_beta05_100obs_5p
aa<-round(RES_nocovariate_beta05_100obs_5p,5)
#library(xtable)
#xtable(aa, type = "latex", file = "filename2.tex")
RES1<-RES_nocovariate_beta05_100obs_5p$V3<0.05
RES1
sum(RES1)


RES_covariate_beta05_100obs_5p<-read.table(file="RES_covariate_beta05_100obs_5p.txt")
RES_covariate_beta05_100obs_5p
bb<-round(RES_covariate_beta05_100obs_5p,5)

RES2<-RES_covariate_beta05_100obs_5p$V3<0.1
RES2
sum(RES2)

#n=50
RES_nocovariate_beta05_50obs_5p<-read.table(file="RES_nocovariate_beta05_50obs_5p.txt")
RES_nocovariate_beta05_50obs_5p
aa<-round(RES_nocovariate_beta05_50obs_5p,5)
#library(xtable)
#xtable(aa, type = "latex", file = "filename2.tex")
RES1<-RES_nocovariate_beta05_50obs_5p$V3<0.1
RES1
sum(RES1)


RES_covariate_beta05_50obs_5p<-read.table(file="RES_covariate_beta05_50obs_5p.txt")
RES_covariate_beta05_50obs_5p
bb<-round(RES_covariate_beta05_50obs_5p,5)

#xtable(bb, type = "latex", file = "filename3.tex")
RES2<-RES_covariate_beta05_50obs_5p$V3<0.1
RES2
sum(RES2)

#n=250
RES_nocovariate_beta05_250obs_5p<-read.table(file="RES_nocovariate_beta05_250obs_5p.txt")
RES1<-RES_nocovariate_beta05_250obs_5p$V3<0.1
RES1
sum(RES1)


RES_covariate_beta05_250obs_5p<-read.table(file="RES_covariate_beta05_250obs_5p.txt")
RES2<-RES_covariate_beta05_250obs_5p$V3<0.1
RES2
sum(RES2)
...
#mesh1
#n=100
RES_nocovariate_beta05_100obs_5p<-read.table(file="RES_nocovariate_beta05_100obs_5p_mesh1.txt")
RES_nocovariate_beta05_100obs_5p
aa<-round(RES_nocovariate_beta05_100obs_5p,5)
#library(xtable)
#xtable(aa, type = "latex", file = "filename2.tex")
...
RES_covariate_beta05_100obs_5p<-read.table(file="RES_covariate_beta05_100obs_5p_mesh1.txt")
RES_covariate_beta05_100obs_5p
bb<-round(RES_covariate_beta05_100obs_5p,5)

RES2<-RES_covariate_beta05_100obs_5p$V3<0.05
RES2
sum(RES2)

#n=50
RES_nocovariate_beta05_50obs_5p<-read.table(file="RES_nocovariate_beta05_50obs_5p_mesh1.txt")
RES_nocovariate_beta05_50obs_5p
aa<-round(RES_nocovariate_beta05_50obs_5p,5)
#library(xtable)
#xtable(aa, type = "latex", file = "filename2.tex")
RES1<-RES_nocovariate_beta05_50obs_5p$V3<0.05
RES1
sum(RES1)


RES_covariate_beta05_50obs_5p<-read.table(file="RES_covariate_beta05_50obs_5p_mesh1.txt")
RES_covariate_beta05_50obs_5p
bb<-round(RES_covariate_beta05_50obs_5p,5)

#xtable(bb, type = "latex", file = "filename3.tex")
RES2<-RES_covariate_beta05_50obs_5p$V3<0.05
RES2
sum(RES2)

#n=250
RES_nocovariate_beta05_250obs_5p<-read.table(file="RES_nocovariate_beta05_250obs_5p_mesh1.txt")
RES1<-RES_nocovariate_beta05_250obs_5p$V3<0.05
RES1
sum(RES1)


RES_covariate_beta05_250obs_5p<-read.table(file="RES_covariate_beta05_250obs_5p_mesh1.txt")
RES2<-RES_covariate_beta05_250obs_5p$V3<0.1
RES2
sum(RES2)
